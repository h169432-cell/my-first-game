...
3. Continue normal catalog expansion with Spirit Island.
...
- Next game for catalog expansion: Spirit Island.
- Current published guide count: 37 total, including Clueverge.

## Completed in this run
- Added `games/race-for-the-galaxy.html` using Rio Grande Games official information plus BoardGameGeek/RulesPal for age and rules-flow cross-checking.
- Added `games/lost-ruins-of-arnak.html` using Czech Games Edition official product information and factsheet.
- Added both titles to `games.html` and raised the catalog count to 37.
- Applied `quick strategy` to Race for the Galaxy and `strategy` to Lost Ruins of Arnak.
- Updated the compact TOP count link from 35 to 37 without adding featured cards.
- Used no new product images because explicit reusable rights were not established.

## Files changed in this run
- `boardgame-guide/games/race-for-the-galaxy.html` (new)
- `boardgame-guide/games/lost-ruins-of-arnak.html` (new)
...
- Catalog initial count and TOP count are both 37.
